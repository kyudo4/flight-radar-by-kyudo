-- An offer is current only after the complete itinerary was verified.
-- Pending/partial Google reads remain available through "all", but must not
-- be presented as current prices in the default dashboard view.
