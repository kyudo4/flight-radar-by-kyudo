(() => {
  ...
  async function connectTelegram() {
    if (!cfg.telegramBotUsername || cfg.telegramBotUsername.includes("YOUR_")) { alert("Administrator nie skonfigurował jeszcze nazwy bota Flight Radar by Kyudo."); return; }
