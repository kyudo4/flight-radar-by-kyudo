...
5. Ustaw sekrety GitHub Actions: `SUPABASE_URL`, `SUPABASE_SERVICE_ROLE_KEY`,
   ...
   migracyjne po stronie serwera. `SUPABASE_DB_PASSWORD` jest opcjonalnym
    ...
    i połączy się przez pooler IPv4 Supabase.
...
startują od maksymalnie 800 zapytań standardowych i 150 First na przebieg. Pozycje kolejki
...
ma osobny, mniejszy budżet 400 + 30 First, aby ponawiać błędne pozycje bez uruchamiania kolejnego
